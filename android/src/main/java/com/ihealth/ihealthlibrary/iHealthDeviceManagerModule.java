...
public class iHealthDeviceManagerModule extends iHealthBaseModule implements LifecycleEventListener {
    ...
    private void commandHandleDeviceNotify(String mac, String deviceType, String action, String message) {
        ...
        switch (deviceType) {
            ...
            case iHealthDevicesManager.TYPE_BG1A:
                module = getReactApplicationContext().getNativeModule(BG1AModule.class);
                break;
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put(BG1A, iHealthDevicesManager.DISCOVERY_BG1A);
    ...
    private DiscoveryTypeEnum getDiscoveryType(String type) {
        ...
        switch (type) {
            ...
            case "BG1A":
                return DiscoveryTypeEnum.BG1A;

            default:
                return DiscoveryTypeEnum.NULL;
