...
public class BPProfileModule extends ReactContextBaseJavaModule {
    ...
    private static final String ACTION_GET_TIME = "ACTION_GET_TIME";
    private static final String TIME_CALIBRATION = "TIME_CALIBRATION";
    private static final String ACTION_SET_STATUS_DISPLAY_SUCCESS = "ACTION_SET_STATUS_DISPLAY_SUCCESS";
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put(ACTION_GET_TIME, BpProfile.ACTION_GET_TIME);
        constants.put(TIME_CALIBRATION, BpProfile.TIME_CALIBRATION);
        constants.put(ACTION_SET_STATUS_DISPLAY_SUCCESS, BpProfile.ACTION_SET_STATUS_DISPLAY_SUCCESS);
