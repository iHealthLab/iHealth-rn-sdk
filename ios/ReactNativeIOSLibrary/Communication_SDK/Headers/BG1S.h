 ...
 * @param disposeBG1SSendCodeBlock  0: means success, 1: means fail. 2:Refuse to update (measuring or performing other actions)

 * @param disposeBGErrorBlock This block returns error codes,please refer to error codes list in BGMacroFile.
 */
-(void)commandSendBGCodeWithCodeString:(NSString*)encodeString DisposeBGSendCodeBlock:(DisposeBG1SSendCodeBlock)disposeBG1SSendCodeBlock DisposeBGErrorBlock:(BlockBG1SError)disposeBGErrorBlock;
/**
