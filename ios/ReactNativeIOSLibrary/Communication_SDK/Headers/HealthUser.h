...
typedef enum{
    HS2SPROImpedanceMark_NO = 0,
    HS2SPROImpedanceMark_YES,
}HS2SPROImpedanceMark;
typedef enum{
    HS2SPROFitnessMark_NO = 0,
    HS2SPROFitnessMark_YES,
}HS2SPROFitnessMark;
...
@property (nonatomic, strong) NSData * hs2SPROUserID;
@end
